...
function DailyFact() {
	return (
		<motion.div
			className="h-56 w-56 p-5 rounded-2xl shadow-xl bg-blue-600 text-white text-center hover:bg-blue-400"
			initial={{ x: "-100%" }}
			animate={{
				x: 0,
			}}>
			<LightningBoltIcon className="h-10 -mt-10 mx-auto" />
			<div className="text-2xl font-bold text-center">Fact of the Day</div>
